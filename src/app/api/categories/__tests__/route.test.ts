...
describe('/api/categories GET', () => {
  ...
  describe('Successful Requests', () => {
    ...
    it('should return categories ordered by sortOrder', async () => {
      ...
      if (data.data.length > 1) {
        expect(data.data[0].sortOrder).toBeLessThanOrEqual(data.data[1].sortOrder)
      }
    })
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully', async () => {
      // Mock database error
      const mockCategoryQueries = require('@/lib/db-utils').CategoryQueries
      mockCategoryQueries.getActiveWithCounts.mockRejectedValueOnce(new Error('Database connection failed'))
    ...
    it('should return structured error response', async () => {
      // Mock database error
      const mockCategoryQueries = require('@/lib/db-utils').CategoryQueries
      mockCategoryQueries.getActiveWithCounts.mockRejectedValueOnce(new Error('Test database error'))
    ...
    it('should handle database timeout errors', async () => {
      ...
      mockCategoryQueries.getActiveWithCounts.mockRejectedValueOnce(timeoutError)
  ...
  describe('Performance Considerations', () => {
    ...
    it('should handle large number of categories efficiently', async () => {
      ...
      mockCategoryQueries.getActiveWithCounts.mockResolvedValueOnce(largeDataset)
