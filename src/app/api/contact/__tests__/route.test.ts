  ...
  describe('Spam Detection', () => {
    it('should detect potential spam in message content', async () => {
      const spamData = {
        ...
        message: 'Click here to make money fast! Bitcoin investment opportunity! Act now!',
      }
    ...
    it('should handle suspicious email domains', async () => {
      const suspiciousData = {
        ...
        subject: 'Test Subject',
        message: 'This is a legitimate message with normal content and enough characters.',
      }
    ...
    it('should handle messages with multiple URLs', async () => {
      const urlSpamData = {
        ...
        message: 'Check out https://site1.com and https://site2.com and https://site3.com for great deals!',
      }
