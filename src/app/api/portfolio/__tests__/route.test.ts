...
describe('/api/portfolio GET', () => {
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      mockPortfolioQueries.getPublishedItems.mockRejectedValueOnce(new Error('Database connection failed'))
    ...
    it('should return structured error response', async () => {
      // Mock database error
      const mockPortfolioQueries = require('@/lib/db-utils').PortfolioQueries
      mockPortfolioQueries.getPublishedItems.mockRejectedValueOnce(new Error('Test error'))
